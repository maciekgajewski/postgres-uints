...
CREATE CAST (int2 AS uint2) WITHOUT FUNCTION AS ASSIGNMENT;
CREATE CAST (uint2 AS int2) WITHOUT FUNCTION;
CREATE CAST (uint2 AS uint4) WITH FUNCTION u2tou4(uint2) AS IMPLICIT;
CREATE CAST (int4 AS uint2) WITH FUNCTION i4tou2(int4) AS ASSIGNMENT;


-- UINT 4 operators

CREATE CAST (int4 AS uint4) WITHOUT FUNCTION AS ASSIGNMENT;
